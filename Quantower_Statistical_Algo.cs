...
namespace Quantower_Statistical_Algo
{
    /// <summary>
    ...
    /// </summary>
	public class Quantower_Statistical_Algo : Strategy
    {
        ...
        public Quantower_Statistical_Algo()
            : base()
        {
            // Defines strategy's name and description.
            this.Name = "Quantower_Statistical_Algo";
